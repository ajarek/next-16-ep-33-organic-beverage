  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-left z-10">
        <h3 className={`font-heading font-black text-3xl md:text-[34px] tracking-tight mb-2 ${textColorClass}`}>
          {title}
        </h3>
        <p className={`text-sm font-bold leading-snug max-w-[90%] ${subtextColorClass}`}>
          {subtext}
        </p>
      </div>
      ...
      <div className="relative flex-1 w-full flex items-center justify-center min-h-[190px] z-10">
        ...
        {/* Obrazek smaku */}
        <div className="relative w-full h-[170px] select-none group-hover:scale-108 transition-transform duration-500">
          <Image
            src={imageSrc}
            alt={title}
            fill
